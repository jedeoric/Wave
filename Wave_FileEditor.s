...
; LOAD SAVE EXIT REFRESH DRIVEA WAVE-MENU

; DRIVE;A LABEL;XXXXXXXXXXXXX FREE;XXXXXX
; XXXXXXXXX MUSIC     XXXXXXXXX MUSIC
; XXXXXXXXX SAMPLESET XXXXXXXXX MUSIC
; XXXXXXXXX EFFECTSET XXXXXXXXX MUSIC
; XXXXXXXXX ORN-SET   XXXXXXXXX MUSIC
; XXXXXXXXX MUSIC     XXXXXXXXX MUSIC
; XXXXXXXXX MUSIC     XXXXXXXXX MUSIC
; XXXXXXXXX MUSIC     XXXXXXXXX MUSIC
; XXXXXXXXX MUSIC     XXXXXXXXX MUSIC
...
FileEditor
	;turn off any song, disable sample, slow irq to normal and restore BASIC IRQ
	sei
	jsr StopSample
	lda #00
	sta MusicStatus
	...
	;Clear pattern area readying for Directory
	jsr ClearPatternArea
	
	;Fetch Directory and display in situ
	jsr FetchAndDisplayFilteredDirectory
	
	;Plot Cursor
	jsr PlotFileCursor
	
	;Wait for key (can't use common control since we are not now using irq routine
