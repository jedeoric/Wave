;Wave Music Compiler 1.00
;
;New to wave 1.0
; Full command support
;  SID channel, status and noise
;  SID buzzer
;  Sample Assign
;  Tempo
;  Pitchbend
; Volume Rest expansion
;  0 Silence Channel
;  1 Decrement Volume
;  2 Increment Volume
;  3 -
; Pattern expansion
;  From 24 to 35 depending on mmUltimatePattern
...
skip5	;If Note is Rest and Volume is Zero then store Volume Zero
	bne skip7
	lda (row),y
	and #3
	bne skip6
